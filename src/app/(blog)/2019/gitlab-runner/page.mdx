...
スタックのパラメータでセキュリティグループidを渡して[SecurityGroupIngress](https://docs.aws.amazon.com/ja_jp/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-security-group-ingress.html)で作成した2つのElastic IPからの接続を許可します。「どこを許可するのか」は下の詰まったところで後述します。
